local alyssetesting = Instance.new("ScreenGui")
...
alyssetesting.Name = "alyssetesting"
alyssetesting.Parent = (game:GetService("CoreGui") or gethui())
alyssetesting.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

main.Name = "main"
main.Parent = alyssetesting
